...
- Adjust tempo by clicking the "50%" indicator in the lower toolbar and entering a value from 1 to 100
- Create a new sequence by clicking the Tone tab, then the Sequence tab, then "Create New Sequence"
- Shift+click a stack of notes to grab the whole chord — then move it as one.

Library and shortcuts:

- Click "Save" in the upper right of the sequence editor to commit your new or edited sequence. Save only appears when a change has been made.
