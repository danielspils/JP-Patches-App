...
[JP Patches for Mac](https://github.com/danielspils/JP-Patches-App/releases/latest/download/JP-Patches.dmg){:.btn-green} [JP Patches for PC](https://github.com/danielspils/JP-Patches-App/releases/tag/v0.8.7-win-preview){:.btn-blue}
